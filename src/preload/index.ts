...
const api: IpcApi = {
  ...
  ambient: {
    ...
    suggest: (id: string, message: string) => ipcRenderer.invoke('ambient:suggest', id, message),
    getIntentThread: (id: string) => ipcRenderer.invoke('ambient:get-intent-thread', id),
